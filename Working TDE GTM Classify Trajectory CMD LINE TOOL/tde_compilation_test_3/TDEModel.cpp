...
TDEModel::TDEModel(FILE* model_file) {
	...
	//cout << "after TDEModel log outs" << endl;
	...
	//cout << "after fscanf" << endl;

	if (use_pca) {

		//cout << "before createMat" << endl;

		bases = cvCreateMat(basesrows, basescols, MAT_TYPE);

		//cout << "after createMat" << endl;
