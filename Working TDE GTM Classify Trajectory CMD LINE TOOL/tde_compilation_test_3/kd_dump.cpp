		...
		FILE *out)					// output stream
{
	...
	*/
	...
	cout << "before first annPrintPt" << endl;

	cout << bnd_box_lo << endl;

	cout << "after the bnd print" << endl;

	annPrintPt(bnd_box_lo, dim, out);	// print lower bound

	cout << "before fprintf after annPrintPt" << endl;

	fprintf(out, "\n"); // out << "\n";

	cout << "after first annPrintPt" << endl;

	annPrintPt(bnd_box_hi, dim, out);	// print upper bound
	fprintf(out, "\n"); // out << "\n";

	cout << "before root == NULL" << endl;
	...
	ANNpoint			&the_bnd_box_hi)		// high bounding point (ret'd)
{
	...
	//cout << "before input the tree" << endl;
