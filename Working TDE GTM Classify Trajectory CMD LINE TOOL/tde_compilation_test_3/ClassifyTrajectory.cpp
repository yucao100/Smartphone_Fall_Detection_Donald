...
Classifier *classifier; //Allows me to not have to create a class, linking error issues
using namespace std;
...
CvMat * classifyTrajectory(const char* in_file ) {

    //std::cout << "inside classify" << std::endl;
    ...
    //std::cout << "before settings" << std::endl;
  ...
  //  system("pause");
   ...
   // cout << "before for" << endl;
    ...
    for (i = 0; i < numModels; i++) {
	 ...
	 //  cout << "after first settings" << endl;
	   ...
	   //cout << "after embedding" << endl;
		...
		//cout << "inside the else after for" << endl;
    ...
    //cout << "before classifyAndSave" << endl;

    CvMat *dist;
    dist = classifier->classifyAndSave(data, tlength);
    
   // cout << "after classifyAndSave" << endl;
